...
public class RecallOverdueNotice
  extends CircNotice
{
  public RecallOverdueNotice()
  {
  }

  public RecallOverdueNotice( String[] tokens, Properties props, 
                              String location )
  {
    super( tokens, props, location );
    setSubject( props.getProperty( "recalloverdue.subject" ) );
  }
  ...
  public String generateNotice()
  {
    ...
    content.append( getProps().getProperty( "recalloverdue.header1" ) );
